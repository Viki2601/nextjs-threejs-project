        ...
        <section className="py-20 px-4 bg-white font-urbanist">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {data?.map((step, index) => (
                        <motion.div key={index} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: index * 0.2 }} viewport={{ once: true }} className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all">
