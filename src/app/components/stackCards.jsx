      ...
      <div className="w-full grid md:grid-cols-2 gap-10 items-center">
        ...
        >
          ...
          <div className="flex flex-col gap-6 md:hidden">
            <motion.div 
              whileHover={{ y: -10 }}
              className="bg-[#F2C94C] p-4 rounded-2xl shadow-xl flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-5"
            >
              <Image src={Banner} alt="Mr Marvis" width={300} height={200} className="rounded-xl object-cover" />
              <h3 className="text-2xl sm:text-3xl font-bold text-[#13293D] mt-2">Mr Marvis</h3>
            </motion.div>
            <motion.div 
              whileHover={{ y: -10 }}
              className="bg-[#14213D] p-4 rounded-2xl shadow-xl flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-5"
            >
              <Image src={Banner} alt="Patta" width={300} height={200} className="rounded-xl object-cover" />
              <h3 className="text-2xl sm:text-3xl font-bold text-white mt-2">Patta</h3>
            </motion.div>
            <motion.div 
              whileHover={{ y: -10 }}
            ...
            >
              ...
              <h3 className="text-2xl sm:text-3xl font-bold text-[#0056D2] mt-2">Tony's Chocolonely</h3>
            </motion.div>
          </div>
          ...
          <div className="hidden md:block relative h-full">
            <motion.div 
              whileHover={{ y: -30 }}
              className="bg-[#F2C94C] p-4 rounded-2xl shadow-xl absolute top-0 w-full flex space-x-5"
            >
              <Image src={Banner} alt="Mr Marvis" width={300} height={200} className="rounded-xl object-cover" />
              <h3 className="text-3xl font-bold text-[#13293D] mt-3">Mr Marvis</h3>
            </motion.div>
            <motion.div 
              whileHover={{ y: -30 }}
              className="bg-[#14213D] p-4 rounded-2xl shadow-xl absolute top-44 w-full flex space-x-5"
            >
              <Image src={Banner} alt="Patta" width={300} height={200} className="rounded-xl object-cover" />
              <h3 className="text-3xl font-bold text-white mt-3">Patta</h3>
            </motion.div>
            <motion.div 
              whileHover={{ y: -30 }}
            ...
            >
              <Image src={Banner} alt="Tony's Chocolonely" width={300} height={200} className="rounded-xl object-cover" />
              <h3 className="text-3xl font-bold text-[#0056D2] mt-3">Tony's Chocolonely</h3>
            </motion.div>
          </div>
        </motion.div>
      </div>
