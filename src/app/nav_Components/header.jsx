...
export default function Header() {
    ...
    return (
        <div className="sticky top-0 left-0 w-full z-50 flex items-center justify-between px-8 py-8 bg-gradient-to-b from-[#003F6B]/90 via-[#003F6B]/50 to-transparent">
            {/* Logo */}
